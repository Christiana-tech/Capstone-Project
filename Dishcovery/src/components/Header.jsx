...
const Header = ({ title, image, type }) => {
  return (
    <div className='w-full h-[100vh]'>
      ...
      <div className='absolute w-full h-full md:h-full sm:max-h-full  bg-gradient-to-t from-black to-transparent top-0 z-8 flex flex-col items-center justify-center pt-40  px-4 '>
