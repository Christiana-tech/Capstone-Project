  ...
  return (
    <div className='w-full h-[100vh]'>
         ...
         <div className= 'relative w-full h-full'>
          ...
          <div className='absolute w-full h-full bg-gradient-to-t from-black to to-transparent
          top-0 z-8 flex flex-col items-center justify-center pt-40 2xl:pt-20 px-4'>
             ...
             type && (
                <p className='text-sm mt-4 text-center text text-green-500
                bg-[#00000090] px-6 pt-4 rounded-full'>
                    Welcome to Dishcovery, your best meal finder!
                    <br className='hidden md:block'/>
                    Discover a treasure trive of delectable recipes from around the globe
                </p>
             )  
          </div>
    </div>
